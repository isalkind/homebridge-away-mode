...
| location | Lat/long location to compute sunrise/sunset from. Use in conjunction with "startTime"\|"endTime" when they are set to "sunrise"\|"sunset".<br>({"lat": x, "long": y}) <br><br>Find your location: [Nominatim Geocoding UI](https://nominatim.openstreetmap.org/ui/search.html) | {"lat": 0, "long": 0} |
